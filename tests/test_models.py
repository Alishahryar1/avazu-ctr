...
def make_test_config(**overrides) -> ConfigType:
    ...
    model_keys = {
        ...
        "use_senet",
        "senet_squeeze_funcs",
        "senet_reduction_ratio",
        "senet_hidden_activation",
        "senet_excitation_activation",
        "senet_num_groups",
        "senet_reweight_mode",
        "senet_use_fuse",
        "senet_use_layer_norm",
        "use_feature_gating",
        "feature_gating_activation",
        "feature_gating_low_rank",
        "mlp_hidden_dims",
        "mlp_activation",
...
class TestModelStructure(unittest.TestCase):
    ...
    def test_model_forward_pass(self):
        ...
        self.assertEqual(
            output["logits"].shape, (batch_size, 1), "Output shape mismatch"
        )
...
class TestMutualExclusivity(unittest.TestCase):
    ...
    def test_both_senet_and_feature_gating_raises_error(self):
        ...
        self.assertIn(
            "Cannot enable both SENET and Feature Gating", str(context.exception)
        )
